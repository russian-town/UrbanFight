...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Combats.Position position { get { return (Code.Gameplay.Features.Combats.Position)GetComponent(GameComponentsLookup.Position); } }
    ...
    public GameEntity AddPosition(UnityEngine.Vector3 newValue) {
        ...
        var component = (Code.Gameplay.Features.Combats.Position)CreateComponent(index, typeof(Code.Gameplay.Features.Combats.Position));

...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Timelines.NormalizedTime normalizedTime { get { return (Code.Gameplay.Features.Timelines.NormalizedTime)GetComponent(GameComponentsLookup.NormalizedTime); } }
    ...
    public GameEntity AddNormalizedTime(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Timelines.NormalizedTime)CreateComponent(index, typeof(Code.Gameplay.Features.Timelines.NormalizedTime));

...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Fighter.CurrentHealth currentHealth { get { return (Code.Gameplay.Features.Fighter.CurrentHealth)GetComponent(GameComponentsLookup.CurrentHealth); } }
    ...
    public GameEntity AddCurrentHealth(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Fighter.CurrentHealth)CreateComponent(index, typeof(Code.Gameplay.Features.Fighter.CurrentHealth));

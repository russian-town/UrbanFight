...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Fighter.MaxHealth maxHealth { get { return (Code.Gameplay.Features.Fighter.MaxHealth)GetComponent(GameComponentsLookup.MaxHealth); } }
    ...
    public GameEntity AddMaxHealth(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Fighter.MaxHealth)CreateComponent(index, typeof(Code.Gameplay.Features.Fighter.MaxHealth));

...
public partial class GameEntity {
    ...
    public Code.Gameplay.Common.ProducerId producerId { get { return (Code.Gameplay.Common.ProducerId)GetComponent(GameComponentsLookup.ProducerId); } }
    ...
    public GameEntity AddProducerId(int newValue) {
        ...
        var component = (Code.Gameplay.Common.ProducerId)CreateComponent(index, typeof(Code.Gameplay.Common.ProducerId));
